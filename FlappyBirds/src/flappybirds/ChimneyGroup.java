...
public class ChimneyGroup {
    ...
    public ChimneyGroup(){
        ...
        try {
            ...
            chimneyImage = ImageIO.read(FlappyBirds.class.getResource("/Assets/chimney.png"));
            
            chimneyImage2 = ImageIO.read(FlappyBirds.class.getResource("/Assets/chimney2.png"));
